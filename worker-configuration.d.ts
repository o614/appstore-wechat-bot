/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 625ee4fb4afc4b7b20abe70519eafacd)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "WECHAT_TOKEN">> {}
}
